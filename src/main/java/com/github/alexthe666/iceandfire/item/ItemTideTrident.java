...
public class ItemTideTrident extends TridentItem {
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot) {
        ...
        if (equipmentSlot == EquipmentSlotType.MAINHAND) {
            ...
            builder.put(Attributes.ATTACK_DAMAGE, new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Weapon modifier", (double)(ATTACK_DAMAGE - 1.0F), AttributeModifier.Operation.ADDITION));
